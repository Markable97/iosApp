...
class HomeTeamController: UITableViewController {

    var players = [PlayerInMatch]()
    
    override func viewDidLoad() {
        super.viewDidLoad()
         print("HomeTeam viewDidLoad")
    ...
    func dataFromMatchConroler(data: [PlayerInMatch]){
        print("Hello from MatchConroler in Home")
        self.players = data
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if row != players.count{
            ...
            case "yellow":
                cell.imageView?.image = UIImage(named: "yellow_card")
            default: break
                
            }
        }else{
            cell.textLabel?.text = "Ассистенты: " + players[row].name
        }
        // Configure the cell...
